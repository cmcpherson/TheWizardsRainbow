...
namespace TheWizardsRainbow
{
    public class Game
    {
        private const ConsoleColor BANNER_COLOR = ConsoleColor.Cyan;
        private const ConsoleColor BANNER_BACKGROUND = ConsoleColor.Black;
        private const ConsoleColor MENU_COLOR = ConsoleColor.Cyan;
        ...
        private void PrintBanner()
        {
            ...
            Console.Write(" The Wizard's Rainbow v1.00 ");
            Console.ForegroundColor = BANNER_COLOR;
            Console.BackgroundColor = BANNER_BACKGROUND;
            Console.WriteLine("█▓▒░");
            Console.WriteLine("░▒▓██████████████████████████████▓▒░");
